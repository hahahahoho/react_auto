...
const CHANGE = 'auth_email/CHANGE';
const GET_POST_PENDING = "auth_email/GET_POST_PENDING";
const GET_POST_SUCCESS = "auth_email/GET_POST_SUCCESS";
const GET_POST_FAILURE = "auth_email/GET_POST_FAILURE";
